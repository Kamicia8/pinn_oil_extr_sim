...
xdmf_file = XDMFFile(MPI.COMM_WORLD, "results/fields/solution_stability.xdmf", "w") #dane wizualne
xdmf_file.write_mesh(domain) 

metrics_file = open("results/metrics/metrics_stability.csv", "w", newline="")
...
if domain.comm.rank == 0:
    ...
    output_path = "results/metrics/fenics_for_pinn_comparison_stability.npy"
